...
struct ProxifierRuleImporterTests {
    ...
    func convertsProfile() throws {
        ...
        #expect(proxyRule.action == .outbound(.profileRules))
    ...
    func resolvesNamesAndCatchAll() throws {
        ...
        #expect(item.rule?.action == .outbound(.profileRules))
    ...
    func parsesOptInLocalProfile() throws {
        ...
        #expect(global.rule?.action == .outbound(.profileRules))
        ...
        #expect(gfw.rule?.action == .outbound(.profileRules))
